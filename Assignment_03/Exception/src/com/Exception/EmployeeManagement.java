...
public class EmployeeManagement {
    ...
    public void hireEmployee(String category, int employeeId, String name, double salary, int rate) throws DemoException {
        try {
            if (category.equals("1")) {
                if (frontDeskHashMap.containsKey(employeeId)) {
                    throw new DemoException("Employee with ID " + employeeId + " already exists.");
                } else {
    ...
    public void fireEmployee(String category, int employeeId) throws EmployeeException {
        try {
            if (category.equals("1")) {
                if (!frontDeskHashMap.containsKey(employeeId)) {
